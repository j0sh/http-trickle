...
in
pkgs.mkShell {
  packages = [ pkgs.ripgrep pkgs.go_1_22 pkgs.python3 pkgs.python3Packages.flask pkgs.python3Packages.numpy pkgs.ffmpeg-full pkgs.python3Packages.pillow pkgs.python3Packages.aiohttp ];
